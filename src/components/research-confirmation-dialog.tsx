...
import { StorytellingToggle } from '@/components/storytelling/storytelling-toggle';

interface ResearchConfirmationDialogProps {
  location: { name: string; lat: number; lng: number } | null;
  onConfirm: (customInstructions?: string, excludedSources?: string[], storyMode?: boolean) => void;
  onCancel: () => void;
  onSignUp?: () => void;
}
...
export function ResearchConfirmationDialog({
  ...
  const [storyMode, setStoryMode] = useState(true); // Default to story mode
  ...
  const handleConfirm = () => {
    ...
    // Always use storytelling mode - no custom instructions
    onConfirm(undefined, excludedSources, true);
  };
